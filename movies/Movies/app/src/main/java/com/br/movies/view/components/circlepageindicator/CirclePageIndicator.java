package com.br.movies.view.components.circlepageindicator;
...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final boolean defaultCentered = resources.getBoolean(R.bool.default_circle_indicator_centered);
        final boolean defaultSnap = resources.getBoolean(R.bool.default_circle_indicator_snap);
    ...
    private int measureLong(int measureSpec) {
        ...
        if ((specMode == MeasureSpec.EXACTLY) || (mViewPager == null)) {
            ...
            final int count = (int) (adapter.getCount() * adapter.getPageWidth(mViewPager.getCurrentItem()));
